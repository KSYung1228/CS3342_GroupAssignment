...
import com.shoprentals.v1.pattern.state.ContractState;
import com.shoprentals.v1.pattern.state.ActiveState;
import com.shoprentals.v1.pattern.state.DraftState;
import com.shoprentals.v1.pattern.state.ExpiredState;
import com.shoprentals.v1.pattern.state.PendingApprovalState;
import com.shoprentals.v1.pattern.state.TerminatedState;
...
public class LeaseContract {
    ...
    public void requestApproval() {
        this.state = this.state.requestApproval();
    }
